    ...
    methods: {
        fetchData: function() {
            ...
            this.$http.post('/api/entry/view', json, {
                ...
                this.text = JSON.stringify(this.content.Payload, null, 2);
                this.title = this.content.Title;
                let msg = this.content.Payload;
                var MyComponent = Vue.component('my-component', {
                    ...
                    render: function(createElement) {
                        if (!this.msg) {
                            ...
                            let torender = [];
                            if(this.msg.values) {
                                this.msg.values.map(function(value, key) {
                                    let str = [];
                                    if(value.elements) {
                                        value.elements.map(function(value, key) {
                                            str.push(createElement('span', " "+value.value+" "));
                                        });
                                    }
                                    torender.push(createElement('div', str));
                                });
                                torender = createElement('div', torender);
